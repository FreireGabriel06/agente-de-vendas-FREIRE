...
with conectar() as c:
    ...
    c.execute("INSERT INTO fornecedores (id,nome,canal,contato,prazo_dias) VALUES (1,'Fábrica Aurora','email','pedidos@aurora.com.br',4)")
    c.execute("INSERT INTO fornecedores (id,nome,canal,contato,prazo_dias) VALUES (2,'Metalpar','whatsapp','+5511999990000',12)")
